...
class TestAvg: 
	def __init__(self): 
		...
		self.avg = tkinter.StringVar() 		# To update average variable
	...
	# The calc_avg method is callback function for the calc_button widget. 
	def calc_avg(self): 
		...
		# Update the avg_label widget by storing the value of self.average in the StringVar object references by avg
